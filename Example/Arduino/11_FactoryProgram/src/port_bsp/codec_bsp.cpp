...
void CodecPort::CodecPort_MusicTask(void *arg) {
	...
	for(;;) {
		uint32_t bytes_write = 0;
  	  	uint32_t bytes_sizt = 0;
  	  	uint8_t *data_ptr = codec->CodecPort_GetPcmData(&bytes_sizt);
...
i2cbus_(i2cbus) 
{
	...
	CodecPort_SetInfo("es8311 & es7210",1,24000,2,16);
